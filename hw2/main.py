    ...
    for lr in learning_rates:
        for units in dense_units:
            ...
            for i in range(kfold):
                print("Starting fold {} for model '{}-{}-{}'".format(i+1, model_name, units, lr))
                ...
                history = model.fit(train_ds[i],
                                    ...
                                    validation_steps=1)  # When an epoch ends, validation generator will yield validation_steps batches
            ...
            model_desc= f"{model_name}-units_{units}-lr_{lr}"
...
# Save best model
best_model.save(os.path.join(model_path, "{}".format(best_model_desc)))
