...
images_train, labels_train, images_valid, labels_valid = utils.load_data('cifar100', DATA_DIR)
...
fig_acc = utils.show_train_history(history, 'accuracy', 'val_accuracy')
plt.savefig(os.path.join(result_path, 'acc_plot.png'))
fig_los = utils.show_train_history(history, 'loss', 'val_loss')
